    ...
    return (
        <div className={styles.CreateWatchlist}>
            ...
            <div className={classnames(styles.CreateWatchlist__input, styles.name)}>
                ...
                <input className={classnames(styles.CreateWatchlist__inputName, styles.inputName)} type='text' value={title} onChange={(e) => setTitle(e.target.value)}></input>
            </div>
            <div className={classnames(styles.CreateWatchlist__input, styles.description)}>
                ...
                <input className={classnames(styles.CreateWatchlist__inputName, styles.inputDescription)} type='text' value={overview} onChange={(e) => setOverview(e.target.value)}></input>
            </div>
            <button className={styles.CreateWatchlist__btn} onClick={() => addList({title, overview, movies})}>Create Watchlist</button>
        </div>
    )
}