...
export const SelectionCart: FC<MovieProps> = ({ id, title, poster_path, overview, genres, popularity, type}) => {
  return (
    <div className={styles.SelectionCart}>
        <img className={styles.SelectionCart__poster} src={API_IMG+poster_path}></img>
        <div>
