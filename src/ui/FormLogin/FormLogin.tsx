        ...
        <div className={styles.FormLogin}>
            ...
            <div className={styles.FormLogin__form}>
                ...
                <div className={styles['FormLogin__form-container']}>
                    ...
                    <input className={styles['FormLogin__form-container_input']} onChange={(e) => setEmail(e.target.value)}></input>
                </div>

                <div className={styles['FormLogin__form-container']}>
                    <p className={styles['FormLogin__form-container_text']}>Password *</p>
                    <input className={styles['FormLogin__form-container_input']} onChange={(e) => setPassword(e.target.value)}></input>
                </div>
 
                <button className={styles['FormLogin__form-btn']} onClick={() => handleClick(password, email)}>Log in</button>
            </div>
        </div>
    )
}